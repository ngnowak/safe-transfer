...
class SingleTransferLimitPolicyTest {

    @Test
    void shouldAllowTransferWhenPolicyIsDisabled() {
        // given
        var policy = new SingleTransferLimitPolicy(new TransferRiskProperties(false, new BigDecimal("100.00")));
    ...
    void shouldAllowTransferAtConfiguredLimit() {
        // given
        var policy = new SingleTransferLimitPolicy(new TransferRiskProperties(true, new BigDecimal("100.00")));
